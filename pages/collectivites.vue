          ...
          >
            ...
            >
              <tr>
                ...
                <th scope="col" class="p-4 pro">Nom</th>
                <th scope="col" class="p-4">Type d'établissement</th>
                <th scope="col" class="p-4">Departement</th>
                <th scope="col" class="p-4">Commune</th>
              ...
              >
                ...
                >
                  <div class="flex items-center mr-3">
                    ...
                    />
                    <p class="truncate ..">{{ col.nom }}</p>
                  </div>
                </th>
                <td class="px-4 py-3">
                  <span
                    class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300"
                    >{{ col.type_service_local }}</span
                  >
                </td>
                <td
                  class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"
